/**
 * marked_custom.js
 * customized marked.js for no tableheader
 * line 94, 219, 395
 *
 * customized code for last cell bugfix
 * line 403
 */
...
block.tables = merge({}, block.gfm, {
  ...
  // customized code for no tableheader
  nptable: /^ *(?:(\S.*\|.*)\n *)?([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
  table: /^ *(?:\|(.+)\n *)?\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
});
  ...
  while (src) {
    ...
    if (top && (cap = this.rules.nptable.exec(src))) {
      ...
      item = {
        ...
        // customized code for no tableheader
        header: (typeof cap[1] === 'undefined') ? [] : cap[1].replace(/^ *| *\| *$/g, '').split(/ *\| */),
